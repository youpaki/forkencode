import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@forkencode/sdk/v2"
import { SessionTurn } from "@forkencode/ui/session-turn"
import { SessionReview } from "@forkencode/ui/session-review"
import { DataProvider } from "@forkencode/ui/context"
import { FileComponentProvider } from "@forkencode/ui/context/file"
import { WorkerPoolProvider } from "@forkencode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@forkencode/ui/logo"
import { IconButton } from "@forkencode/ui/icon-button"
import { ProviderIcon } from "@forkencode/ui/provider-icon"
import { iife } from "@forkencode/core/util/iife"
import { Binary } from "@forkencode/core/util/binary"
import { NamedError } from "@forkencode/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@forkencode/ui/tabs"
import { MessageNav } from "@forkencode/ui/message-nav"
import { FileSSR } from "@forkencode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@forkencode/ui/pierre/worker").then((m) => ({
