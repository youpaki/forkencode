...
export const TypeId: TypeId = "~@forkencode/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@forkencode/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@forkencode/effect-sqlite-node/NodeSqliteClient")
