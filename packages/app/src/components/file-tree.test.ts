...
beforeAll(async () => {
  ...
  mock.module("@forkencode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@forkencode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@forkencode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@forkencode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
