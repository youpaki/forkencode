...
} from "@forkencode/plugin/tui"
import stripAnsi from "strip-ansi"
import type { TuiConfig } from "./config/tui"
import { isAttentionSoundName } from "./config/tui-schema"
import * as TuiAudio from "@tui/util/audio"
import defaultSoundPath from "@forkencode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@forkencode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@forkencode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@forkencode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@forkencode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@forkencode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "forkencode"
