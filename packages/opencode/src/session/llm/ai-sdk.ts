import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@forkencode/llm"
...
// Move this extraction into @forkencode/llm when Copilot is handled by the native runtime.
