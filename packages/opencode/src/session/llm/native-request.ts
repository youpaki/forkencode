import type { JsonSchema, LLMRequest, ProviderMetadata } from "@forkencode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@forkencode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @forkencode/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
